    ...
    return (
        <div className="p-7 flex flex-row bg-white w-full h-14 items-center">
            ...
            <div className="flex ml-auto gap-3">
                <button className="hover:cursor-pointer"><img src={RebootIcon} alt="Reboot" className="w-10 h-10 hover:opacity-75 transition"></img></button>
                <button className="hover:cursor-pointer"><img src={ShutdownIcon} alt="Shutdown" className="w-10 h-10 hover:opacity-75 transition"></img></button>
            </div>
        </div>
    );
}